package com.danish.bookstore_backend.services;

import com.danish.bookstore_backend.dto.BookDTO;
import com.danish.bookstore_backend.entities.Book;
import com.danish.bookstore_backend.dto.GenreDTO;
import com.danish.bookstore_backend.entities.*;
import com.danish.bookstore_backend.repositories.*;
import com.danish.bookstore_backend.utils.ErrorsUtil;
import com.danish.bookstore_backend.utils.validators.BookValidator;
...
public class BookService {
    ...
    @Autowired
    public BookService(ModelMapper modelMapper, BookValidator bookValidator,BookRepository bookRepository,
                       GenreRepository genreRepository, CheckoutRepository checkoutRepository, PersonRepository personRepository,
                       PaymentRepository paymentRepository,  HistoryRecordRepository historyRecordRepository) {
...
//  <------------------------------------------------------------------------------->
    ...
    @Transactional
    public BookDTO addBook(@Valid BookDTO bookDTO, BindingResult bindingResult) {
